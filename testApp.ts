...
// solana balance *publicWalletAddress* --url RPC-Node-Provider-Address check balance via solana cli
// run "ts-node testApp.ts" in terminal

const SOLANA_RPC = 'RPC-Node-Provider-Address';
